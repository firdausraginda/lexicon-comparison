    ...
    for kata in hasilNGram2:
        for i in range(0, len(lexCustom)):
            if (kata == lexCustom[i][0]):
                ...
                elif lexCustom[i][1] < 0 :
                    sentiWordNegatif = lexCustom[i][0]
                    weightNegatif = -1
                    arrNegatifNGram2.append([sentiWordNegatif,weightNegatif])
                elif lexCustom[i][1] == 0 :
                    sentiWordNetral = lexCustom[i][0]
                    weightNetral = 0
                    arrPositifNGram2.append([sentiWordNetral,weightNetral])
        ...
        for i in range(0, len(lexCustom)):
            if (kata == lexCustom[i][0]):
                if lexCustom[i][1] > 0 :
                    ...
                    sentiWordNetral = lexCustom[i][0]
                    weightNetral = 0
                    arrPositifNGram1Strip.append([sentiWordNetral,weightNetral])
...
hasilImport, hasilLabelManual = importExcelDataSet(dosen_1)
